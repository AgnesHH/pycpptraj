...
class TestPyCpptrajIO(unittest.TestCase):
    def test_blindload(self):
        ...
        traj = mdio.load(fname="./data/md1_prod.Tc5b.x", top="./data/Tc5b.top")
    ...
    def test_load_and_save(self):
        traj = mdio.load(fname="./data/md1_prod.Tc5b.x", top="./data/Tc5b.top")
        trajiter = mdio.iterload(fname="./data/md1_prod.Tc5b.x", top="./data/Tc5b.top", chunk=100)
        print trajiter

        indices = range(20, 30, 5) + [103, 78, 90, 82]
        mdio.writetraj(fname="./output/test_io_saved.x", 
                       traj=traj, 
                       top="./data/Tc5b.top",
                       fmt='AMBERTRAJ', 
                       indices=indices)
        ...
        # check frames
        traj = mdio.load(fname="./output/test_io_saved.x", top="./data/Tc5b.top")
