...
#endif
#include <math.h>
#define __PYX_HAVE__test_Vec3
#define __PYX_HAVE_API__test_Vec3
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'test_Vec3' */
static Vec3 *__pyx_v_9test_Vec3_p;
#define __Pyx_MODULE_NAME "test_Vec3"
int __pyx_module_is_main_test_Vec3 = 0;

/* Implementation of 'test_Vec3' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inittest_Vec3(void); /*proto*/
PyMODINIT_FUNC inittest_Vec3(void)
#else
PyMODINIT_FUNC PyInit_test_Vec3(void); /*proto*/
PyMODINIT_FUNC PyInit_test_Vec3(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_test_Vec3(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("test_Vec3", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_test_Vec3) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "test_Vec3")) {
      if (unlikely(PyDict_SetItemString(modules, "test_Vec3", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init test_Vec3", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init test_Vec3");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
