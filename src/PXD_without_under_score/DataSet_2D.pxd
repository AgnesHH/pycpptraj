...
cdef extern from "DataSet_2D.h": 
    ...
    ctypedef enum MatrixKind "DataSet_2D::MatrixKind":
        ...
        TRI "DataSet_2D::TRI"
    cdef cppclass DataSet_2D "DataSet_2D":
        DataSet_2D() 
        DataSet_2D(DataType tIn, int wIn, int pIn): DataSet(tIn, wIn, pIn, 2)
        void Add(size_t, const void *)
        const char * MatrixTypeString(MatrixType m)
        const char * MatrixOutputString(MatrixType m)
    cdef cppclass DataSet_2D::MatrixToken "DataSet_2D::MatrixToken":
