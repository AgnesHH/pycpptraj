...
cdef extern from "Atom.h": 
    ...
    cdef cppclass Atom "Atom":
        Atom() 
        Atom(const NameType&, char, const char *)
        Atom(const NameType&, const NameType&, double)
        Atom(const NameType&, double, double, const NameType&)
        Atom(const NameType&, double, double, int, double, int, const NameType&, double, double)
        Atom(const Atom&)
        void swap(Atom&, Atom&)
        #Atom& operator =(Atom)
        ...
        inline const NameType& Type() const 
