...
cdef extern from "DistRoutines.h":
    ...
    double _DIST2_ImageNonOrtho "DIST2_ImageNonOrtho"(const _Vec3 &, const _Vec3 &, const _Matrix_3x3 &, const _Matrix_3x3 &)
    ...
    double _DIST_NoImage "DIST2_NoImage"( const _Vec3&, const _Vec3& )
