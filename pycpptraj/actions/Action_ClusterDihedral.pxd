...
cdef class Action_ClusterDihedral::DCnode (Action):
    cdef _Action_ClusterDihedral::DCnode* thisptr

cdef class Action_ClusterDihedral (Action):
    cdef _Action_ClusterDihedral* thisptr

cdef class Action_ClusterDihedral::DCmask (Action):
    cdef _Action_ClusterDihedral::DCmask* thisptr
