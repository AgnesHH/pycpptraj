...
cdef class Action_MakeStructure::SS_TYPE (Action):
    cdef _Action_MakeStructure::SS_TYPE* thisptr

cdef class Action_MakeStructure::SecStructHolder (Action):
    cdef _Action_MakeStructure::SecStructHolder* thisptr
