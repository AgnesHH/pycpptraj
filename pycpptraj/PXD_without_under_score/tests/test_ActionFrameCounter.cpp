...
#endif
#include <math.h>
#define __PYX_HAVE__test_ActionFrameCounter
#define __PYX_HAVE_API__test_ActionFrameCounter
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'ActionFrameCounter' */

/* Module declarations from 'test_ActionFrameCounter' */
static ActionFrameCounter *__pyx_v_23test_ActionFrameCounter_p;
#define __Pyx_MODULE_NAME "test_ActionFrameCounter"
int __pyx_module_is_main_test_ActionFrameCounter = 0;

/* Implementation of 'test_ActionFrameCounter' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inittest_ActionFrameCounter(void); /*proto*/
PyMODINIT_FUNC inittest_ActionFrameCounter(void)
#else
PyMODINIT_FUNC PyInit_test_ActionFrameCounter(void); /*proto*/
PyMODINIT_FUNC PyInit_test_ActionFrameCounter(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_test_ActionFrameCounter(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("test_ActionFrameCounter", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_test_ActionFrameCounter) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "test_ActionFrameCounter")) {
      if (unlikely(PyDict_SetItemString(modules, "test_ActionFrameCounter", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * del p
 */
  __pyx_v_23test_ActionFrameCounter_p = new ActionFrameCounter();

  /* "test_ActionFrameCounter.pyx":8
 * cdef ActionFrameCounter * p = new ActionFrameCounter()
 * 
 * del p             # <<<<<<<<<<<<<<
 */
  delete __pyx_v_23test_ActionFrameCounter_p;

  /* "test_ActionFrameCounter.pyx":2
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init test_ActionFrameCounter", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init test_ActionFrameCounter");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
